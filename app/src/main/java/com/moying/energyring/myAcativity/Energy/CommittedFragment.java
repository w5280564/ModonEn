 ...
 * 公众承诺
 */
public class CommittedFragment extends Fragment implements XRecyclerView.LoadingListener{
...
//        tableData(saveFile.BaseUrl+"/Study/Search");
    ...
    public void initlist(final Context context) {
        ...
        mAdapter = new CommittedFragment_Adapter(context, baseModel, listModel);
