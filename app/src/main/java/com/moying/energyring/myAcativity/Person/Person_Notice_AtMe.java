...
import com.moying.energyring.myAdapter.Person_NoticeAtMe_Adapter;
...
public class Person_Notice_AtMe extends Activity implements XRecyclerView.LoadingListener {
...
//        seekData(Person_Notice_Nomm.this,saveFile.BaseUrl + saveFile.seekUser_Url + "?PageIndex=" + PageIndex + "&PageSize=" + pageSize + "&SearchKey=" + "S");
        seekData(Person_Notice_AtMe.this, saveFile.BaseUrl + saveFile.AtMe_Url + "?PageIndex=" + PageIndex + "&PageSize=" + pageSize);
    }
...
//        ListData(saveFile.BaseUrl + saveFile. + "?Type=1&PageIndex=" + PageIndex + "&PageSize=" + pageSize);
    ...
    Person_NoticeAtMe_Adapter mAdapter;
...
//        All_XRecy.setLayoutParams(itemParams);
        ...
        mAdapter = new Person_NoticeAtMe_Adapter(context, ListModel, seekModel);
        All_XRecy.setAdapter(mAdapter);
        mAdapter.setOnItemClickLitener(new Person_NoticeAtMe_Adapter.OnItemClickLitener() {
            @Override
