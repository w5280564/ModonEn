...
public class Person_myShareActivity extends Activity implements PlatformActionListener, Handler.Callback {
...
//    private String shareUrl = "";
    ...
    public void shareWechatFriend() {
        ...
        if (shareContent.imgpath  == null) {
            Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.person_badge_bg);
