...
public class Person_Notice_Nomm extends Activity implements XRecyclerView.LoadingListener {
...
//        seekData(Person_Notice_Nomm.this,saveFile.BaseUrl + saveFile.seekUser_Url + "?PageIndex=" + PageIndex + "&PageSize=" + pageSize + "&SearchKey=" + "S");
        seekData(Person_Notice_Nomm.this, saveFile.BaseUrl + saveFile.Notice_Comment_Url + "?PageIndex=" + PageIndex + "&PageSize=" + pageSize);
    }
...
//        ListData(saveFile.BaseUrl + saveFile. + "?Type=1&PageIndex=" + PageIndex + "&PageSize=" + pageSize);
    ...
    Person_NoticeNomm_Adapter mAdapter;
...
//        All_XRecy.setLayoutParams(itemParams);
        ...
        mAdapter = new Person_NoticeNomm_Adapter(context, ListModel, seekModel);
