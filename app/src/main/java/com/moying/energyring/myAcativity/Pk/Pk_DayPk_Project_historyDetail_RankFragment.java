...
import com.moying.energyring.myAdapter.HistoryDetail_RankFragment_Adapter;
 ...
 *
 */
public class Pk_DayPk_Project_historyDetail_RankFragment extends lazyLoadFragment implements XRecyclerView.LoadingListener {
    ...
    public static Pk_DayPk_Project_historyDetail_RankFragment newInstance(String Type, String ProjectID, DayPkDetail_Model Integral_Model) {
        Pk_DayPk_Project_historyDetail_RankFragment newFragment = new Pk_DayPk_Project_historyDetail_RankFragment();
...
//        other_recycle.setLoadingMoreEnabled(false);//底部不加载
    ...
    HistoryDetail_RankFragment_Adapter mAdapter;
    ...
    public void initlist(final Context context) {
        ...
        mAdapter = new HistoryDetail_RankFragment_Adapter(context, baseModel, listModel);
        other_recycle.setAdapter(mAdapter);
        mAdapter.setOnItemClickLitener(new HistoryDetail_RankFragment_Adapter.OnItemClickLitener() {
            @Override
