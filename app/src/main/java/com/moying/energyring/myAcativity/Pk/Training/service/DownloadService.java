package com.moying.energyring.myAcativity.Pk.Training.service;
...
import com.moying.energyring.myAcativity.Pk.Training.constant.SPKey;
import com.moying.energyring.myAcativity.Pk.Training.utils.DownloanThread;
import com.moying.energyring.myAcativity.Pk.Training.utils.GetFileSharePreance;
import com.moying.energyring.myAcativity.Pk.Training.utils.SPUtils;
...
public class DownloadService extends Service {
    ...
    public void onCreate() {
        ...
        preance = MyApplication.getFileSharePreance();//获取缓存实例，这里的缓存主要用在APP关闭后，重新进入下载列表后显示使用
        super.onCreate();
    }
    ...
    public class MyBinder extends Binder {
        ...
        public void registDownLoadListener(
                OnDownLoadBackListener loadBackListener) {
        ...
        //停止下载
        public void DownLoadStop(FileInfo fileInfo) {
            if (fileInfo != null && !TextUtils.isEmpty(fileInfo.getUrl())) {
