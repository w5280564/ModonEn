...
import com.moying.energyring.myAdapter.HistoryDetail_HistoryFragment_Adapter;
 ...
 *
 */
public class Pk_DayPk_Project_HistoryDetail_HistoryFragment extends lazyLoadFragment implements XRecyclerView.LoadingListener {
    ...
    public static Pk_DayPk_Project_HistoryDetail_HistoryFragment newInstance(String Type, String ProjectID, DayPkDetail_Model Integral_Model) {
        Pk_DayPk_Project_HistoryDetail_HistoryFragment newFragment = new Pk_DayPk_Project_HistoryDetail_HistoryFragment();
...
//        other_recycle.setLoadingMoreEnabled(false);//底部不加载
    ...
    HistoryDetail_HistoryFragment_Adapter mAdapter;
    public void initlist(final Context context) {
        LinearLayoutManager mMangaer = new LinearLayoutManager(context);
        other_recycle.setLayoutManager(mMangaer);
        //如果可以确定每个item的高度是固定的，设置这个选项可以提高性能
        other_recycle.setHasFixedSize(true);
        mAdapter = new HistoryDetail_HistoryFragment_Adapter(context, baseModel, listModel);
        other_recycle.setAdapter(mAdapter);
        mAdapter.setOnItemClickLitener(new HistoryDetail_HistoryFragment_Adapter.OnItemClickLitener() {
            @Override
