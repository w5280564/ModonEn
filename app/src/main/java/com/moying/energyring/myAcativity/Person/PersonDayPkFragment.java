...
import com.moying.energyring.myAdapter.Person_DayPkFragment_Adapter;
 ...
 * PK记录
 */
public class PersonDayPkFragment extends lazyLoadFragment implements XRecyclerView.LoadingListener {
    ...
    public static PersonDayPkFragment newInstance(String Type, String UserID) {
        PersonDayPkFragment newFragment = new PersonDayPkFragment();
...
//        tableData(saveFile.BaseUrl+"/Study/Search");
    ...
    Person_DayPkFragment_Adapter mAdapter;
    ...
    public void initlist(final Context context) {
        ...
        mAdapter = new Person_DayPkFragment_Adapter(context, baseModel);
        other_recycle.setAdapter(mAdapter);
        mAdapter.setOnItemClickLitener(new Person_DayPkFragment_Adapter.OnItemClickLitener() {
            @Override
