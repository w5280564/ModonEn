...
public class Pk_DayPk_Community_PerNew extends lazyLoadFragment implements XRecyclerView.LoadingListener {
    ...
    private String stringtype, ProjectID;
    ...
    public static Pk_DayPk_Community_PerNew newInstance(String stringtype, String UserID, String ProjectID) {
        Pk_DayPk_Community_PerNew newFragment = new Pk_DayPk_Community_PerNew();
...
//        ListData(saveFile.BaseUrl + saveFile.EnergyListUrl + "?Type=1&PageIndex=" + PageIndex + "&PageSize=" + pageSize);
        ListData(saveFile.BaseUrl + saveFile.Community_Post_List_Url + "?OrderType=" + stringtype + "&ProjectID=" + ProjectID + "&PageIndex=" + PageIndex + "&PageSize=" + pageSize);
    }
...
//        LinearLayoutManager mMangaer = new LinearLayoutManager(context);
        ...
        mAdapter = new CommunitStaggerFragment_Adapter(context, baseModel, listModel);
        other_recycle.setAdapter(mAdapter);
        mAdapter.setOnItemClickLitener(new CommunitStaggerFragment_Adapter.OnItemClickLitener() {
            @Override
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String resultString) {
                if (resultString != null) {
                    ...
                    listModel = new Gson().fromJson(resultString, Community_List_Model.class);
