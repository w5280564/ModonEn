 ...
 */
public class Find_BannerDetail extends Activity {
...
//            Intent intent = new Intent(learn_WebDetail.this, ShareActivity.class);
            ...
            Intent intent = new Intent(Find_BannerDetail.this, ShareFindActivity.class);
...
//                Util.showToast(MainActivity.this, "下载成功");
                ...
                try {
                    ...
                    Toast.makeText(Find_BannerDetail.this, "保存成功", Toast.LENGTH_SHORT).show();
                } catch (FileNotFoundException e) {
                    e.printStackTrace();
                    Toast.makeText(Find_BannerDetail.this, "保存失败", Toast.LENGTH_SHORT).show();
                }
                // 最后通知图库更新
...
//                Util.showToast(MainActivity.this, "下载失败");
    ...
    public void UserID_Get(int UserId) {
        Intent intent = new Intent(Find_BannerDetail.this, PersonMyCenter_And_Other.class);
