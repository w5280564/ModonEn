...
public class Radio_ShadowTransformerTest implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer {
    ...
    private FindRadioListActivityTest context;

    public Radio_ShadowTransformerTest(FindRadioListActivityTest context, RadioList_Model radioModel, ViewPager viewPager, Radio_CardAdapter adapter, SimpleDraweeView radio_bg, TextView radio_Name_Txt) {
...
//        if (myplayer != null && !context.ifplay) {
//            radioPlayUrl(pos);
//        } else {
//            radioPauseset(pos);
//            myplayer.pause(context, context.ifplay);
//        }
//
//
