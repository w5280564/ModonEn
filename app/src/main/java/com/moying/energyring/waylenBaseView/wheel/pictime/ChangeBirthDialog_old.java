package com.moying.energyring.waylenBaseView.wheel.pictime;
 ...
 *
 */
public class ChangeBirthDialog_old extends Dialog implements View.OnClickListener {
	...
	public ChangeBirthDialog_old(Context context) {
