 ...
 */
public class DayPk_HistoryFragment_Adapter extends RecyclerView.Adapter<DayPk_HistoryFragment_Adapter.MyViewHolder> {
    List<ReportHistory_Model.DataBean> otherList;
    private ReportHistory_Model listModel;
    Context context;
    private int myposition;

    public DayPk_HistoryFragment_Adapter(Context context, List<ReportHistory_Model.DataBean> otherList, ReportHistory_Model listModel) {
