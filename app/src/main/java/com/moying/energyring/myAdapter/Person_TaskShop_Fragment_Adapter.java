 ...
 */
public class Person_TaskShop_Fragment_Adapter extends RecyclerView.Adapter<Person_TaskShop_Fragment_Adapter.MyViewHolder> {
    List<Person_ShopList_Model.DataBean> otherList;
    private Person_ShopList_Model listModel;
    Context context;
    private int myposition;

    public Person_TaskShop_Fragment_Adapter(Context context, List<Person_ShopList_Model.DataBean> otherList, Person_ShopList_Model listModel) {
...
//        this.otherList = otherList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.person_taskshop_adapter, null));
        return myview;
    }
...
//        return 10;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            StaticData.ViewScale(shop_Rel, 355, 470);
            StaticData.ViewScale(content_simple, 350, 350);
            StaticData.ViewScale(exchange_Btn, 80, 36);
        }
    }
