 ...
 */
public class Leran_Goal_Add_Adapter extends RecyclerView.Adapter<Leran_Goal_Add_Adapter.MyViewHolder> {
    //    List<AllPerson_Model.DataBean> otherList;
    Goal_Model baseModel;
    Context context;
    private int myposition;

    public Leran_Goal_Add_Adapter(Context context, Goal_Model baseModel) {
