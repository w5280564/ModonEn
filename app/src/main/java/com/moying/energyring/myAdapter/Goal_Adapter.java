 ...
 */
public class Goal_Adapter extends RecyclerView.Adapter<Goal_Adapter.MyViewHolder> {
    //    List<AllPerson_Model.DataBean> otherList;
    Goal_Model baseModel;
    Context context;
    private int myposition;

    public Goal_Adapter(Context context, Goal_Model baseModel) {
...
//        this.otherList = otherList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.goal_adapter, null));
        return myview;
    }
