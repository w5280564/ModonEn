 ...
 */
public class Pk_FenRank_Adapter extends RecyclerView.Adapter<Pk_FenRank_Adapter.MyViewHolder> {
    List<Pk_FenRankList_Model.DataBean> otherList;
    private Pk_FenRankList_Model listModel;
    Context context;
    private int myposition;

    public Pk_FenRank_Adapter(Context context, List<Pk_FenRankList_Model.DataBean> otherList, Pk_FenRankList_Model listModel) {
        this.otherList = otherList;
        this.context = context;
        this.listModel = listModel;
    }

    public void addMoreData(List<Pk_FenRankList_Model.DataBean> otherList) {
//        this.otherList = otherList;
...
//        position = position -1;
        ...
        Pk_FenRankList_Model.DataBean oneData = otherList.get(position);
        ...
        holder.all_Txt.setText(oneData.getAllIntegral()+"分");
    }
