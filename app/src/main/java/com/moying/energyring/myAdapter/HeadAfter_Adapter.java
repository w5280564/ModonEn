 ...
 */
public class HeadAfter_Adapter extends RecyclerView.Adapter<HeadAfter_Adapter.MyViewHolder> {
    ...
    public HeadAfter_Adapter(Context context, List<Recommend_Model.DataBean> otherList, Recommend_Model listModel) {
...
//        this.otherList = otherList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.headafter_adapter, null));
        return myview;
    }
...
//                        notifyDataSetChanged();
                        notifyItemChanged(pos); //刷新一个item
