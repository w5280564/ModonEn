 ...
 */
public class Person_DayPkFragment_Adapter extends RecyclerView.Adapter<Person_DayPkFragment_Adapter.MyViewHolder> {
    person_daypk_Model otherList;
    Context context;
    private int myposition;

    public Person_DayPkFragment_Adapter(Context context, person_daypk_Model otherList) {
        this.otherList = otherList;
        this.context = context;
    }

    public void addMoreData(List<person_daypk_Model.DataBean> otherList) {
//        this.otherList = otherList;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        person_daypk_Model.DataBean oneData = otherList.getData().get(position);
        holder.time_Txt.setText("今日排名："+oneData.getRanking());
