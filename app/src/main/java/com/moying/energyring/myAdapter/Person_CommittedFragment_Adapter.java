 ...
 */
public class Person_CommittedFragment_Adapter extends RecyclerView.Adapter<Person_CommittedFragment_Adapter.MyViewHolder> {
    List<Committed_Model.DataBean> otherList;
    Context context;
    private int myposition;

    public Person_CommittedFragment_Adapter(Context context, List<Committed_Model.DataBean> otherList) {
...
//        this.otherList = otherList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder  myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.person_commitedfragment_adapter, null));
        return myview;
    }
