 ...
 */
public class HistoryDetail_HistoryFragment_Adapter extends RecyclerView.Adapter<HistoryDetail_HistoryFragment_Adapter.MyViewHolder> {
    List<ReportHistory_Model.DataBean> otherList;
    private ReportHistory_Model listModel;
    Context context;
    private int myposition;

    public HistoryDetail_HistoryFragment_Adapter(Context context, List<ReportHistory_Model.DataBean> otherList, ReportHistory_Model listModel) {
...
//        this.otherList = otherList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.historydetail_historyfragment_adapter, null));
        return myview;
    }
