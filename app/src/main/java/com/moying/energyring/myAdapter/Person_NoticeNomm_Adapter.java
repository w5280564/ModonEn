 ...
 */
public class Person_NoticeNomm_Adapter extends RecyclerView.Adapter<Person_NoticeNomm_Adapter.MyViewHolder> {
    ...
    public Person_NoticeNomm_Adapter(Context context, List<Notice_Nomm_Model.DataBean> otherList, Notice_Nomm_Model listModel) {
