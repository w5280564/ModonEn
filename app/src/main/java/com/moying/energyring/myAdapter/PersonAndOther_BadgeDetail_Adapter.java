 ...
 */
public class PersonAndOther_BadgeDetail_Adapter extends RecyclerView.Adapter<PersonAndOther_BadgeDetail_Adapter.MyViewHolder> {
    Person_BadgeAll_Model.DataBean baseModel;
    Context context;
    private int myposition;

    public PersonAndOther_BadgeDetail_Adapter(Context context, Person_BadgeAll_Model.DataBean baseModel) {
...
//        notifyDataSetChanged();
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Person_BadgeAll_Model.DataBean.InsigniaListBean oneData = baseModel.getInsignia_List().get(position);
    ...
    public int getItemCount() {
        ...
        return (baseModel == null) ? 0 : baseModel.getInsignia_List().size();//数据加一项
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView badgeName_Txt,badgeContent_Txt;
        ...
        public MyViewHolder(View itemView) {
            ...
            StaticData.ViewScale(badge_Lin, 250, 330);
