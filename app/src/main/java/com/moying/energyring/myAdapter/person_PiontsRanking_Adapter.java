 ...
 */
public class person_PiontsRanking_Adapter extends RecyclerView.Adapter<person_PiontsRanking_Adapter.MyViewHolder> {
    List<Person_Pionts_Model.DataBean.UserSortListBean> otherList;
    private Person_Pionts_Model listModel;
    Context context;
    private int myposition;

    public person_PiontsRanking_Adapter(Context context, List<Person_Pionts_Model.DataBean.UserSortListBean> otherList,  Person_Pionts_Model listModel) {
        this.otherList = otherList;
        this.context = context;
        this.listModel = listModel;
    }

    public void addMoreData(List<Person_Pionts_Model.DataBean.UserSortListBean> otherList) {
//        this.otherList = otherList;
...
//        position = position -1;
        ...
        Person_Pionts_Model.DataBean.UserSortListBean oneData = otherList.get(position);
        ...
        holder.all_Txt.setText(oneData.getIntegral()+"");
    }
