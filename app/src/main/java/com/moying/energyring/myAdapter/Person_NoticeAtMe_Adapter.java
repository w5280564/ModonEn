 ...
 */
public class Person_NoticeAtMe_Adapter extends RecyclerView.Adapter<Person_NoticeAtMe_Adapter.MyViewHolder> {
    ...
    public Person_NoticeAtMe_Adapter(Context context, List<Notice_Nomm_Model.DataBean> otherList, Notice_Nomm_Model listModel) {
...
//            StaticData.lodingheadBg(holder.my_Head);
        ...
        holder.content_Txt.setText("提到了你");
