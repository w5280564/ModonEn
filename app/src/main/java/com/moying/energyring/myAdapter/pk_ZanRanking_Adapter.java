 ...
 */
public class pk_ZanRanking_Adapter extends RecyclerView.Adapter<pk_ZanRanking_Adapter.MyViewHolder> {
    List<ZanList_Model.DataBean> otherList;
    private ZanList_Model listModel;
    Context context;
    private int myposition;

    public pk_ZanRanking_Adapter(Context context, List<ZanList_Model.DataBean> otherList, ZanList_Model listModel) {
        this.otherList = otherList;
        this.context = context;
        this.listModel = listModel;
    }

    public void addMoreData(List<ZanList_Model.DataBean> otherList) {
//        this.otherList = otherList;
...
//        position = position -1;
        ...
        ZanList_Model.DataBean oneData = otherList.get(position);
