 ...
 */
public class HistoryDetail_RankFragment_Adapter extends RecyclerView.Adapter<HistoryDetail_RankFragment_Adapter.MyViewHolder> {
    List<DayPkList_Model.DataBean> otherList;
    private DayPkList_Model listModel;
    Context context;
    private int myposition;

    public HistoryDetail_RankFragment_Adapter(Context context, List<DayPkList_Model.DataBean> otherList, DayPkList_Model listModel) {
...
//        this.otherList = otherList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.historydetail_rankfragment, null));
        return myview;
    }
...
//        position = position -1;
        ...
        if (oneData.getCreateTime() != null) {
            ...
            sbf.append(oneData.getCreateTime().toString().substring(5, 16));
        ...
        if (oneData.getLimit() == 1) {
            ...
            if (oneData.getReportNum() >= oneData.getLimit()) {
                holder.count_Txt.setText(nf.format(oneData.getLimit()) + "+");
            } else {
