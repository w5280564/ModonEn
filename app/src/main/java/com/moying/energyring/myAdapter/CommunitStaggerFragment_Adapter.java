 ...
 */
public class CommunitStaggerFragment_Adapter extends RecyclerView.Adapter<CommunitStaggerFragment_Adapter.MyViewHolder> {
    List<Community_List_Model.DataBean> otherList;
    private Community_List_Model listModel;
    Context context;
    private int myposition;
    final int POST_TYPE = 4;

    public CommunitStaggerFragment_Adapter(Context context, List<Community_List_Model.DataBean> otherList, Community_List_Model listModel) {
        this.otherList = otherList;
        this.context = context;
        this.listModel = listModel;
    }

    public void addMoreData(Community_List_Model list) {
...
//        }
        ...
        final Community_List_Model.DataBean oneData = otherList.get(position);
            ...
            public void onSuccess(String resultString) {
                if (resultString != null) {
                    ...
                    if (model.isIsSuccess()) {
                        Community_List_Model.DataBean oneData = otherList.get(pos);
                        if (oneData.getIs_Like() == 1) {
