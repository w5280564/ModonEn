 ...
 */
public class FeedbackFragment_Adapter extends RecyclerView.Adapter<FeedbackFragment_Adapter.MyViewHolder> {
    ...
    public FeedbackFragment_Adapter(Context context, List<EnergyList_Model.DataBean> otherList, EnergyList_Model listModel) {
...
//            StaticData.addPlace(holder.content_simple, context);
        ...
        holder.talk_Txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String content = oneData.getPostContent();
                String postId = oneData.getPostID() + "";
                String url = saveFile.BaseUrl + "/Share/PostDetails?PostID=" + oneData.getPostID();
                Intent intentTalk = new Intent(context, Energy_WebDetail.class);
                intentTalk.putExtra("content", content);
                intentTalk.putExtra("postId", postId);
                intentTalk.putExtra("url", url);
                intentTalk.putExtra("imgUrl", oneData.getFilePath());
...
//        return 10;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            viewTouchDelegate.expandViewTouchDelegate(like_Lin, 100, 100, 50, 50);
            ...
            public void onSuccess(String resultString) {
                if (resultString != null) {
                    ...
                    if (model.isIsSuccess()) {
                        ...
                        notifyItemRemoved(pos + 2);//加1是有头部 +2 添加了参与说明
