 ...
 */
public class History_Coust_Adapter extends RecyclerView.Adapter<History_Coust_Adapter.MyViewHolder> {
    List<ReportHistory_Model.DataBean> otherList;
    private ReportHistory_Model listModel;
    Context context;
    private int myposition;

    public History_Coust_Adapter(Context context, List<ReportHistory_Model.DataBean> otherList, ReportHistory_Model listModel) {
...
//        this.otherList = otherList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.history_coust_adapter, null));
        return myview;
    }
...
//        sbf.insert(6, "\n");
        ...
        holder.head_Txt.setText(oneData.getProjectName());
...
//        return 20;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private  TextView time_Txt,project_Name,count_Txt,rank_Txt,head_Txt;
        ...
        public MyViewHolder(View itemView) {
            ...
            StaticData.ViewScale(project_simple, 90, 90);
        }
    }
