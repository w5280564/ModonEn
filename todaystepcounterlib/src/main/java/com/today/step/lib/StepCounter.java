...
//                        int step = (int) (lastSensorStep - AppSharedPreferencesHelper.getVitalityStepOffset(mContext));
                        Logger.e(TAG, "跨越0点 event.value[0]：" + event.values[0]);
                        Logger.e(TAG, "跨越0点 ：上一次计步器步数" + AppSharedPreferencesHelper.getVitalityLastSensorStep(mContext));
...
//            AppSharedPreferencesHelper.setVitalityStepOffset(mContext,lastSensorStep);//使用上次计算步数
