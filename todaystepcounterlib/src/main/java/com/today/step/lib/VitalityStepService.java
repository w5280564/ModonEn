...
import com.today.step.lib.Static.PostAndPk_Add;
import com.today.step.lib.Static.saveFile;
...
//                                }
//                            });
//                    AddPk_Data(VitalityStepService.this, saveFile.BaseUrl + saveFile.AddPk_Url, "");
                    break;
                }
    ...
    public void AddPk_Data(final Context context, String baseUrl, String files) {
        ...
        try {
            ...
            for (int i = 0; i < 1; i++) {
                ...
                obj.put("ProjectID", "35");
                obj.put("ReportNum", StepDcretor.CURRENT_SETP);
                jsonArray.put(obj);
            }
